...
Hauler::Hauler(Transport& transport) : transport_(transport) {}

bool Hauler::sendFile(const std::string& filePath, const std::string& destIp) {
    ...
    std::vector<uint8_t> testFrame = {'F', 'H', '\x01', 'H', 'E', 'L', 'L', 'O'};
...
void Hauler::recvFiles(const std::string& outDir) {
